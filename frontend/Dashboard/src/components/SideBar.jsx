        ...
        <>
            ...
            >
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span className="ms-3">Salesway</span>
                            </a>
                        </li>
                        ...
                        <li>
                            ...
                            >
                                <svg
                                    ...
                                    viewBox="0 0 20 20"
                                >
                                    <path d="M11 2a1 1 0 1 0 0-2H9a1 1 0 1 0 0 2v1.054a6.978 6.978 0 0 0-3.11 1.282L4.4 3.846A1 1 0 1 0 3 5.255l1.507 1.506A6.979 6.979 0 0 0 3.001 9.89H2a1 1 0 1 0 0 2h1.001a6.978 6.978 0 0 0 1.282 3.11L3.846 15.6A1 1 0 0 0 5.255 17l1.492-1.49a6.978 6.978 0 0 0 3.11 1.282V18a1 1 0 1 0 2 0v-1.001a6.978 6.978 0 0 0 3.11-1.282L15.6 16.154A1 1 0 1 0 17 14.745l-1.507-1.507a6.978 6.978 0 0 0 1.282-3.11H18a1 1 0 1 0 0-2h-1.001a6.979 6.979 0 0 0-1.282-3.11L16.154 4.4A1 1 0 1 0 14.745 3l-1.492 1.49A6.978 6.978 0 0 0 10.11 3.054V2H11Zm-1 15a5 5 0 1 1 0-10 5 5 0 0 1 0 10Z" />
                                </svg>
                    ...
                    <div className="absolute bottom-0 left-0 w-full p-4 bg-gray-50 dark:bg-gray-800">
                        <div className="flex items-center space-x-4">
                            <img
                                ...
                                alt="User profile"
                            />
                            <span className="text-gray-900 dark:text-white">Alice Wang</span>
                        </div>
                    </div>
